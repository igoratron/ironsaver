...
public class SimpleSettingsProvider : SettingsProvider
{
    ...
    {
        return Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData) + @"\igormatics\IronSaver\";
    }
